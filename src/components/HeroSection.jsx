    ...
    <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="md:w-1/2 mb-12 md:mb-0">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-10">
          <button className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-full transition-all duration-200 text-lg">
            I AM BRAND
          </button>
          <button className="border-2 border-orange-500 text-orange-500 font-bold py-3 px-8 rounded-full transition-all duration-200 text-lg hover:bg-orange-50">
            I AM INFLUENCER
          </button>
        </div>
        {/* Stats */}
      ...
      <div className="md:w-1/2 flex justify-center relative">
        ...
        <div className="absolute -z-10 right-0 top-10 w-96 h-96 bg-orange-100 rounded-full opacity-70 hidden md:block"></div>
        <img
        ...
        <div className="absolute -z-10 left-0 bottom-0 w-56 h-40 bg-gray-100 rounded-full opacity-70 hidden md:block"></div>
      </div>
    </div>
  </section>
);
